...
var D={sw:[
{t:"MacAdBlock",s:"done",d:"macOS DNS ad-blocker daemon on :8053.",g:[{c:"ac",l:"macOS"},{l:"DNS"},{l:"Python"},{l:"launchd"}],a:[{c:"ac",l:"Launch :8053",o:1,u:"http://192.168.1.165:8053"}],v:[{n:"V1",i:"Basic hosts file."},{n:"V2",i:"Daemon mode: launchd, auto-start."},{n:"V3",L:1,i:"System-wide: blocks ads in EVERY app."}]},
{t:"ESP32-C3 AdBlock",s:"done",d:"Network DNS sinkhole on ESP32. Blocks ads for all WiFi devices.",g:[{c:"ac",l:"ESP32"},{l:"C"},{l:"DNS"},{l:"IoT"}],v:[{n:"Note",i:"C3 incompatible with RT-AC58U WPA2. Used WROOM-32D."}]},
{t:"FrostSolve",s:"done",d:"macOS desktop app with manifest structure and full .app bundle.",g:[{c:"ac",l:"macOS"},{l:"App"},{l:"JavaScript"}],v:[{n:"V1",i:"Standalone script."},{n:"V2",L:1,i:"App bundle: Finder/Dock launchable."}]},
{t:"IsaacNetPkg",s:"done",d:"Password-protected .pkg. AppleScript uninstall.",g:[{c:"ac",l:"macOS"},{l:"pkgbuild"},{l:"AppleScript"},{l:"launchd"}],v:[{n:"V1",i:"AppleScript in bash heredocs. Broke."},{n:"V2",L:1,i:"Fixed: AppleScript as real file."}]},
{t:"IsaacSecureMessenger",s:"done",d:"E2E encrypted messaging - X3DH + AES-256-GCM.",g:[{c:"ac",l:"macOS"},{l:"Encryption"},{l:"AES-256"},{l:"PyObjC"}],v:[{n:"V1",i:"Browser chat. Manual key exchange."},{n:"V2",i:"Native app: QR code pairing."},{n:"V3",L:1,i:"X3DH protocol. Production grade."}]},
{t:"Multiplayer Game Server",s:"done",d:"WebSocket multiplayer backend - multi-room, sync, spectator.",g:[{c:"ac",l:"WebSocket"},{l:"Python"},{l:"FastAPI"},{l:"Real-time"}],v:[{n:"V1",i:"Single room."},{n:"V2",i:"Multi-room with room codes."},{n:"V3",L:1,i:"Spectator mode + reconnect."}]},
{t:"HKPCBypass",s:"done",d:"Multi-layer school bypass. DoH+SOCKS5+HTTP CONNECT.",g:[{c:"ac",l:"Networking"},{l:"Proxy"},{l:"DoH"},{l:"Python"}],a:[{c:"ac",l:"Launch :8560",o:1,u:"http://192.168.1.165:8560"}],v:[{n:"V1",i:"Single proxy."},{n:"V2",i:"DoH added: encrypted DNS."},{n:"V3",L:1,i:"Multi-layer fallback."}]},
{t:"WiFi Chat",s:"done",d:"LAN offline chat - no internet needed. WebSocket + DXF sharing.",g:[{c:"ac",l:"WebSocket"},{l:"Flask"},{l:"LAN"},{l:"Offline"}],v:[{n:"V1",i:"Basic text."},{n:"V2",i:"DXF/SVG uploads."},{n:"V3",L:1,i:"Offline-first. Cross-device."}]},
{t:"WiFi Monitor",s:"done",d:"ESP32 WiFi scanner - signal graphs, device tracking.",g:[{c:"ac",l:"ESP32"},{l:"WiFi"},{l:"Scanner"},{l:"C"}],v:[{n:"V1",i:"Serial only."},{n:"V2",i:"MAC tracking."},{n:"V3",L:1,i:"Full dashboard."}]},
{t:"326929.pw Mirror",s:"done",d:"Full phishing site mirror - evidence for takedowns.",g:[{c:"gr",l:"Security"},{l:"Phishing"},{l:"Evidence"}],v:[{n:"V1",i:"Manual save."},{n:"V2",L:1,i:"wget mirror: all assets."}]},
{t:"Scam Mirror",s:"done",d:"Automated phishing cloner - registrar takedown reports.",g:[{c:"gr",l:"Security"},{l:"Scraping"},{l:"Python"}],v:[{n:"V1",i:"Manual per-site."},{n:"V2",L:1,i:"Automated: one command."}]},
{t:"IsaacKing Browser",s:"done",d:"Whitelist-only browser. PyObjC + WKWebView .app.",g:[{c:"ac",l:"macOS"},{l:"WKWebView"},{l:"PyObjC"},{l:"Browser"}],v:[{n:"V1",i:"White screen bug."},{n:"V2",L:1,i:"Fixed: HTML string direct load."}]},
{t:"IsaacBrowser",s:"done",d:"Variant browser - category-based whitelist.",g:[{c:"ac",l:"macOS"},{l:"Browser"},{l:"PyObjC"}],v:[{n:"V1",i:"IsaacKing fork."},{n:"V2",L:1,i:"Independent codebase."}]},
{t:"IsaacNet",s:"done",d:"Layered bypass. TLS-wrapped, multi-tunnel auto-fallback.",g:[{c:"ac",l:"Networking"},{l:"Proxy"},{l:"Python"},{l:"Bypass"}],a:[{c:"ac",l:"Launch :8570",o:1,u:"http://192.168.1.165:8570"}],v:[{n:"V1",i:"Single TCP tunnel."},{n:"V2",i:"TLS wrapping."},{n:"V3",L:1,i:"Layered: CONNECT+SOCKS5+WS."}]},
{t:"Manufacturing Explorer",s:"done",d:"200-method 3D manufacturing explorer. Three.js + Flask.",g:[{c:"ac",l:"Three.js"},{l:"Flask"},{l:"3D"},{l:"G-code"}],a:[{c:"ac",l:"Launch :8530",o:1,u:"http://192.168.1.165:8530"},{l:"Preview",o:7,u:"http://192.168.1.165:8530"}],v:[{n:"V1",i:"112 methods."},{n:"V2",i:"Collapsible panels."},{n:"V3",L:1,i:"200 methods."}]},
{t:"IsaacCombo",s:"done",d:"Multi-app .pkg - user selects apps.",g:[{c:"ac",l:"macOS"},{l:"pkgbuild"},{l:"Installer"}],v:[{n:"V1",i:"All-or-nothing."},{n:"V2",L:1,i:"Fixed: choice dialog."}]},
{t:"Macro Typer",s:"done",d:"Types text char-by-char - bypasses Google Docs history.",g:[{c:"ac",l:"Python"},{l:"pyautogui"},{l:"Tkinter"},{l:"macOS"}],v:[{n:"V1-4",i:"Invisible app."},{n:"V5",L:1,i:"Fixed: launch notification."}]},
{t:"Godzilla AI Chat",s:"done",d:"Godzilla-themed AI roleplay. TUI + GUI. Native .app.",g:[{c:"ac",l:"AI"},{l:"macOS"},{l:"Chat"},{l:"TUI"}],v:[{n:"V1",i:"Terminal TUI."},{n:"V2",i:"GUI with history."},{n:"V3",L:1,i:"Native .app. Themed UI."}]},
{t:"Isaac AI",s:"done",d:"AI chat assistant - native .app. Multi-personality, memory.",g:[{c:"ac",l:"AI"},{l:"macOS"},{l:"Chat"},{l:"App"}],v:[{n:"V1",i:"Single-turn."},{n:"V2",i:"Multi-turn with context."},{n:"V3",L:1,i:"Native .app WKWebView."}]},
{t:"IsaacSuite",s:"wip",d:"Unified launcher - one dock icon for all Isaac apps.",g:[{c:"ac",l:"macOS"},{l:"Launcher"},{l:"PyObjC"}],v:[{n:"V1",i:"Planned: menubar widget."}]},
{t:"IsaacAppLaunchers",s:"done",d:"Quick-launch scripts for the Isaac ecosystem.",g:[{c:"ac",l:"macOS"},{l:"Scripting"},{l:"Automation"}],v:[{n:"V1",i:"Individual scripts."},{n:"V2",L:1,i:"Unified launcher."}]},
{t:"IsaacOS",s:"draft",d:"Custom OS concept - bootable with all Isaac tools.",g:[{l:"OS"},{l:"Concept"},{l:"System Design"}],v:[{n:"V1",i:"Concept phase."}]},
{t:"IsaacSystem-All",s:"draft",d:"Monolithic tool - all Isaac apps in one binary.",g:[{l:"System"},{l:"Unified"},{l:"Meta-project"}],v:[{n:"V1",i:"Concept phase."}]},
{t:"Laser Cutting Simulator",s:"done",d:"Browser laser simulator - 9+ versions. G-code export.",g:[{c:"ac",l:"React"},{l:"DXF"},{l:"Simulation"},{l:"Web App"}],v:[{n:"V1-3",i:"Basic canvas."},{n:"V4-6",i:"3D isometric."},{n:"V7-9",L:1,i:"True 3D orbital, G-code."}]}
],hw:[
{t:"Auto-Clamping Vise",s:"wip",d:"Arduino Nano + NEMA 17 + ACS712 sensor. 3D printed. ~$32.",g:[{c:"ac",l:"Arduino"},{l:"Stepper"},{l:"3D Printed"},{l:"Current Sense"}],v:[{n:"V1",i:"Concept."},{n:"V2",i:"ACS712 current detection."},{n:"V3",L:1,i:"Calibrating."}]},
{t:"Clip-On Thermometer",s:"done",d:"ESP32 temp sensor with OpenSCAD enclosure.",g:[{c:"ac",l:"ESP32"},{l:"Sensor"},{l:"PlatformIO"},{l:"OpenSCAD"}],v:[{n:"V1",i:"Breadboard."},{n:"V2",i:"Enclosure."},{n:"V3",L:1,i:"Production."}]},
...
{t:"Micro RC Car",s:"wip",d:"1/64-1/32 scale high-speed. No-solder Dupont build.",g:[{c:"ac",l:"RC"},{l:"Micro"},{l:"No-solder"},{l:"Speed"}],v:[{n:"V1",i:"Design phase."}]},
{t:"BLE Scanner",s:"wip",d:"ESP32 BLE device scanner - detect, log, dashboard.",g:[{c:"ac",l:"ESP32"},{l:"BLE"},{l:"Scanner"},{l:"IoT"}],v:[{n:"V1",i:"Research phase."}]}
],f3d:[
...
{t:"CNC Mill Tool Head Box",s:"done",d:"Single to dual slot. Improved latch.",g:[{c:"ac",l:"CNC"},{l:"Storage"}],v:[{n:"V1",i:"Single slot."},{n:"V2",L:1,i:"Dual slot."}]},
...
{t:"Rocket Flour Sifter",s:"done",d:"5 iterations. Recovered after crash.",g:[{c:"ac",l:"Kitchen"},{l:"Mechanism"},{l:"Rocket"}],v:[{n:"V1",i:"Mesh clogged."},{n:"V6",L:1,i:"Recovered: 5 refinements."}]},
...
{t:"Knurl Bearing",s:"done",d:"Heaviest at 16.7 MB. Knurled raceways.",g:[{c:"ac",l:"Bearings"},{l:"Knurling"},{l:"Complex"}]},
{t:"VEX IQ Acrylic Box",s:"done",d:"V1-V3: vents, cutouts, standoffs.",g:[{c:"ac",l:"VEX"},{l:"Enclosure"},{l:"Acrylic"}],v:[{n:"V1",i:"No ventilation."},{n:"V3",L:1,i:"Added vents + cutouts."}]},
...
{t:"VEX PIN TWEEZER V5",s:"done",d:"Specialized VEX pin tool.",g:[{c:"ac",l:"VEX"},{l:"Tool"}]},
...
{t:"Masterball",s:"done",d:"Pokemon Masterball replica. 2-part printable.",g:[{c:"ac",l:"Pokemon"},{l:"Replica"}]},
{t:"Halo Helmet V2",s:"done",d:"Wearable. V2 dowels for assembly.",g:[{c:"ac",l:"Halo"},{l:"Helmet"},{l:"Cosplay"}],v:[{n:"V1",i:"Too big."},{n:"V2",L:1,i:"Split with dowels."}]},
...
{t:"Dura Block",s:"done",d:"Sanding block replica. Text + plain.",g:[{l:"Sanding"},{l:"Tool"}],v:[{n:"Text",i:"Branded."},{n:"Plain",L:1,i:"Cleaner."}]},
...
{t:"Canva Designs",s:"wip",d:"Canva via school Google. DAHIIX_Dw0Q. 57 MB.",g:[{c:"gr",l:"Canva"},{l:"Cloud"},{l:"Design"}]},
{t:"Google Drive Portfolio",s:"wip",d:"Docs + Slides. isaac_cs.chan@online.island.edu.hk.",g:[{c:"ac",l:"Google"},{l:"Cloud"}]},
