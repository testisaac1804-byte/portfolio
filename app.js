...
{t:"OS Kernel (from scratch)",s:"draft",pt:"prompts/os-kernel-prompt.md",d:"x86 OS kernel from scratch — bootloader, kernel, lib.",g:[{c:"gr",l:"OS"},{l:"x86"},{l:"Assembly"},{l:"C"}],a:[{l:"Open Folder",o:1,u:"./projects/os-kernel/"}]},
{t:"CNC Drill Box",s:"draft",pt:"prompts/cnc-drill-box-prompt.md",d:"CNC drill bit storage box (v1–v3).",g:[{c:"gr",l:"CNC"},{l:"Storage"},{l:"Draft"}]},
{t:"F1 Canvas",s:"draft",pt:"prompts/f1-canvas-prompt.md",d:"F1 canvas experiment.",g:[{c:"gr",l:"F1"},{l:"Canvas"},{l:"Draft"}],a:[{l:"Open Folder",o:1,u:"./projects/f1-canvas/"}]},
{t:"IsaacNet Browser",s:"done",pt:"prompts/isaacnet-browser-prompt.md",d:"Browser frontend for the IsaacNet proxy.",g:[{c:"gr",l:"Networking"},{l:"Browser"},{l:"Proxy"}],a:[{l:"Open Folder",o:1,u:"./projects/isaacnet-browser/"}]},
{t:"School Shield",s:"done",pt:"prompts/school-shield-prompt.md",d:"Network shield — toggles school-filter DNS blocking.",g:[{c:"gr",l:"Networking"},{l:"DNS"},{l:"Bypass"}],a:[{l:"Open Folder",o:1,u:"./projects/school-shield/"}]},
{t:"Red Star Browser",s:"done",pt:"prompts/red-star-browser-prompt.md",d:"Red Star browser app (macOS).",g:[{c:"gr",l:"macOS"},{l:"Browser"},{l:"App"}],a:[{l:"Open Folder",o:1,u:"./projects/red-star-browser/"}]},
{t:"Y10 IGCSE Launcher",s:"done",pt:"prompts/igcse-launcher-prompt.md",d:"Launcher that opens the IGCSE study guide.",g:[{c:"gr",l:"macOS"},{l:"Launcher"},{l:"IGCSE"}],a:[{l:"Open Folder",o:1,u:"./projects/igcse-launcher/"}]},
{t:"Y10 IGCSE OTP Generator",s:"done",pt:"prompts/igcse-otp-prompt.md",d:"One-time-password generator for IGCSE access.",g:[{c:"gr",l:"Security"},{l:"OTP"},{l:"IGCSE"}],a:[{l:"Open Folder",o:1,u:"./projects/igcse-otp/"}]},
{t:"WiFi Toggle",s:"done",pt:"prompts/wifi-toggle-prompt.md",d:"One-click WiFi on/off toggle.",g:[{c:"gr",l:"macOS"},{l:"WiFi"},{l:"Automation"}],a:[{l:"Open Folder",o:1,u:"./projects/wifi-toggle/"}]}
],hw:[
...
{t:"CNC Mill Tool Head Box",s:"done",pt:"prompts/cnc-mill-tool-head-box-prompt.md",d:"Single to dual slot. Improved latch. By Man Cheuk (Ronin).",how:"Designed by Man Cheuk (Ronin).",a:[{c:"p3d",l:"View 3D",o:2,p:"./Downloads/cnc drill bit case.stl"}],g:[{c:"ac",l:"CNC"},{l:"Storage"},{l:"Man Cheuk"}],v:[{n:"V1",i:"Single slot."},{n:"V2",L:1,i:"Dual slot."}]},
