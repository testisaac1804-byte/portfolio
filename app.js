...
{t:"GCSE Home",s:"done",pt:"prompts/gcse-home-prompt.md",d:"Rebuilt copy of the school's Toddle GCSE Home dashboard — My Classes (9), assignments & deadlines, events and Sentral quick links. Data snapshot Sept 2026. Single-file HTML, light theme.",a:[{c:"ac",l:"Live Demo",o:7,u:"./demos/gcse-home.html"}],g:[{c:"ac",l:"Dashboard"},{l:"School"},{l:"GCSE"},{l:"HTML"},{l:"Education"}],v:[{n:"V1",L:1,i:"Rebuilt Toddle GCSE Home: classes, deadlines, events, quick links, localStorage done-marking."}]}
],hw:[
