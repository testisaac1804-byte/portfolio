...
var D={sw:[
{t:"MacAdBlock",s:"done",d:"macOS DNS ad-blocker daemon on :8053. Blocks ads system-wide.",g:[{c:"ac",l:"macOS"},{l:"DNS"},{l:"Python"},{l:"launchd"}],v:[{n:"V1",i:"Basic hosts file."},{n:"V2",i:"Daemon mode: launchd, auto-start."},{n:"V3",L:1,i:"System-wide: blocks ads in EVERY app."}]},
...
{t:"HKPCBypass",s:"done",d:"Multi-layer school bypass. DoH+SOCKS5+HTTP CONNECT with fallback.",g:[{c:"ac",l:"Networking"},{l:"Proxy"},{l:"DoH"},{l:"Python"}],v:[{n:"V1",i:"Single proxy."},{n:"V2",i:"DoH added: encrypted DNS."},{n:"V3",L:1,i:"Multi-layer fallback."}]},
...
{t:"IsaacNet",s:"done",d:"Layered bypass. TLS-wrapped, multi-tunnel auto-fallback.",g:[{c:"ac",l:"Networking"},{l:"Proxy"},{l:"Python"},{l:"Bypass"}],v:[{n:"V1",i:"Single TCP tunnel."},{n:"V2",i:"TLS wrapping."},{n:"V3",L:1,i:"Layered: CONNECT+SOCKS5+WS."}]},
{t:"Manufacturing Explorer",s:"done",d:"200-method 3D manufacturing explorer. Three.js + Flask.",g:[{c:"ac",l:"Three.js"},{l:"Flask"},{l:"3D"},{l:"G-code"}],a:[{c:"ac",l:"Launch :8530",o:1,u:"http://192.168.1.165:8530"}],v:[{n:"V1",i:"112 methods."},{n:"V2",i:"Collapsible panels."},{n:"V3",L:1,i:"200 methods."}]},
