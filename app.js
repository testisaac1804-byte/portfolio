...
"BetterTerminal":{how:"A real macOS terminal: Python owns actual PTY login shells, xterm.js paints them in a native window, and a rule-based plain-English layer turns “locate to desktop” into cd ~/Desktop (showing the command first so you learn it). Tabs, split panes, search, themes, command history with exit codes, and a confirm dialog before anything destructive.",src:"Python (aiohttp + ptyprocess + pywebview), xterm.js, PyInstaller, pkgbuild."},
